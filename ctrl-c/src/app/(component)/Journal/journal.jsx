      ...
      <div className={styles["journal-container"]}>
        ...
        <div className={styles["journal-content"]}>
          ...
          <div className={styles["image-container"]}>
            <img src="distraction.png" width="270" alt="Journal Image" />{" "}
          ...
          <div className={styles["text-container"]}>
            <p>
              Please use this space to express your feelings, successes, or
              simply jot down the little things that bring you joy. Start off by
              entering the date and use this as an opportunity to pause,
              breathe, and be honest with yourself—no matter what you’re going
              through.
            </p>
          </div>
        </div>
