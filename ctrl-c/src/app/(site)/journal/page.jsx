...
import { db } from "../(site)/firebase/firebaseConfig"; // Import Firebase configuration
			...
			<div className="journal-content">
				...
				<div className="text-container">
					<p>
						...
						bring you joy. Start off by entering the date and use
						this as an opportunity to pause, breathe, and be honest
						with yourself—no matter what you’re going through.
					</p>
				</div>
			</div>
